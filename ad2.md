...
En este apartado de la actividad dirigida 2 ponemos el **código en bruto completo en la parte de abajo** para explicar lo que hemos realizado en la otra actividad llamada [scraping.ipynb](https://github.com/nebrijas/Periodismodedatos_juancamilobohorquez/scraping.ipynb).
